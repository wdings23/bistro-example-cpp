...
namespace Render
{
    namespace Vulkan
    {
        ...
        protected:
            ...
            {
                std::unique_ptr<RenderDriver::Vulkan::CBuffer>          mBuffer;
                VkStridedDeviceAddressRegionKHR                         mStridedDeviceAddressRegion;
                void*                                                   mpMapped;
            };
            ...
            VkDeviceAddress mBottomAccelerationDeviceAddress;
            VkAccelerationStructureKHR mBottomLevelASHandle;

            std::unique_ptr<RenderDriver::Vulkan::CBuffer> mpBottomLevelAccelerationStructureBuffer;
            std::unique_ptr<RenderDriver::Vulkan::CBuffer> mpInstanceBuffer;
            std::unique_ptr<RenderDriver::Vulkan::CBuffer> mTLASBuffer;
            std::unique_ptr<RenderDriver::Vulkan::CBuffer> mTransformBuffer;
        ...
        public:
            ...
            inline VkSampler& getNativeLinearSampler()
            {
                return mNativeLinearSampler;
            }

            inline VkSampler& getNativePointSampler()
            {
                return mNativePointSampler;
            }
            ...
            protected:
                ...
                VkSampler                           mNativeLinearSampler;
                VkSampler                           mNativePointSampler;

            protected:
                std::map<std::string, std::unique_ptr<Render::Vulkan::CRenderJob>> maRenderJobs;
                std::map<std::string, std::unique_ptr<RenderDriver::Vulkan::CCommandBuffer>> maRenderJobCommandBuffers;
                std::map<std::string, std::unique_ptr<RenderDriver::Vulkan::CCommandAllocator>> maRenderJobCommandAllocators;
                std::map<std::string, std::unique_ptr<RenderDriver::Vulkan::CBuffer>> maVertexBuffers;
                std::map<std::string, std::unique_ptr<RenderDriver::Vulkan::CBuffer>> maIndexBuffers;
                std::map<std::string, std::unique_ptr<RenderDriver::Vulkan::CBuffer>> maTrianglePositionBuffers;

                std::unique_ptr<RenderDriver::Vulkan::CCommandBuffer> mSwapChainCommandBuffer;
                std::unique_ptr<RenderDriver::Vulkan::CCommandAllocator> mSwapChainCommandAllocator;
        
                std::unique_ptr<RenderDriver::Vulkan::CBuffer>           mDefaultUniformBuffer;
                std::map<std::string, std::unique_ptr<RenderDriver::Vulkan::CAccelerationStructure>> maAccelerationStructures;
        };

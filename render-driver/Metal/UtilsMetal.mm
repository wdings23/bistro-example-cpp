            ...
            */
            MTLPixelFormat convert(RenderDriver::Common::Format format)
            {
                ...
                switch(format)
                {
                        ...
                        CASE(RenderDriver::Common::Format::D32_FLOAT_S8X24_UINT, MTLPixelFormatDepth24Unorm_Stencil8)
                        CASE(RenderDriver::Common::Format::R32_FLOAT_X8X24_TYPELESS, MTLPixelFormatDepth24Unorm_Stencil8)
